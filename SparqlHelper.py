...
#         print '\n\nLatest expression: ' + latestExpression + '\n\n'
        ...
        latestExpression = re.sub('^.*eu/id/', '/id/', latestExpression) + '/data.xml'
...
#         print 'title: ' + title
    ...
    def getCitedWorkForReference(self, reference):
        ...
        query = 'SELECT ?cited {\
                    {\
                        ...
                        SELECT ?cited WHERE {\
                                 <' + reference + '> <http://www.metalex.eu/schema/1.0#cites> ?cited } LIMIT 1\
                    }\
                }'
    ...
    def datesForExpressions(self, expressions):
        ...
        for expression in expressions:
            ...
            expressionDict[dateTuple[1]] = re.sub("wetten/doc", "id", expression)
            dates += [dateTuple]
